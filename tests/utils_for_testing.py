...
from proj.rules_framework import _test_rule as real_test_rule


class patch_rules:
    """
    usage: with mock_rules(is_admin=False):
    ...
    def __init__(self, **rule_stubs):
        self._patch = patch(
            "proj.rules_framework._test_rule", self.rule_mocker(**rule_stubs)
        )
